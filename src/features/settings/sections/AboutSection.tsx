    ...
    <div className="space-y-6 animate-in fade-in duration-100">
      ...
      <div className="bg-white dark:bg-[#141418] rounded-xl border border-slate-200 dark:border-white/[0.07] p-5 shadow-2xs space-y-4">
        ...
        {checked && !updateInfo && !error && (
          <div className="p-3 rounded-lg bg-emerald-50 dark:bg-emerald-950/20 border border-emerald-200 dark:border-emerald-800/40 text-xs text-emerald-800 dark:text-emerald-200 flex items-center gap-2">
            <CheckCircle2 className="w-4 h-4 text-emerald-600 dark:text-emerald-400 shrink-0" />
            <span>You are on the latest version (v0.2.1).</span>
          </div>
        )}
        ...
        {updateInfo && (
          <div className="p-4 rounded-lg bg-blue-50 dark:bg-blue-950/30 border border-blue-200 dark:border-blue-800/40 text-xs space-y-3">
            ...
            {updateInfo.body && (
              <div className="text-[11px] text-slate-600 dark:text-zinc-300 bg-white dark:bg-[#101014] p-2.5 rounded border border-blue-100 dark:border-white/[0.06] whitespace-pre-wrap max-h-32 overflow-y-auto">
                {updateInfo.body}
              </div>
            )}
          </div>
