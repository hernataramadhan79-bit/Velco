...
if (import.meta.env.DEV && typeof window !== 'undefined' && !('__TAURI_INTERNALS__' in window)) {
  ...
  const mockItems = [
    ...
    },
    {
      ...
      content: '# Velco Dual-Mode Core\n\n- **Mode 1: Personal Workspace**: Virtualized items, Workbench, instant capture.\n- **Mode 2: Capsules**: Air-gapped LAN project capsules, 3-column Kanban, AI synthesis recipes.',
      source: 'quick_capture',
      status: 'inbox',
      favorite: 1,
      archived: 0,
  ...
  const mockCapsuleItems = [
    ...
    },
    {
      ...
      type: 'note',
      title: 'Velco Architectural Specification — Local-First Context Preservation',
      content: 'Mode 1 Personal Workspace & Mode 2 Capsules.',
      source: 'capsule',
      status: 'inbox',
      favorite: 1,
      archived: 0,
